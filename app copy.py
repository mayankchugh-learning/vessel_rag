...
def load_chain():
    ...
    prompt = PromptTemplate(
        ...
        template="""You are a cargo documentation assistant specializing in IATA interchange message procedures.
...
# ── MAIN UI ───────────────────────────────────────────────────
st.title("🚢 Vessel Documentation RAG Chatbot")
